#!/usr/bin/env python3
"""
Recuperation des codes promo Prozis depuis shopilo.fr
Sursa: https://shopilo.fr/reductions/prozis.com
"""
...
SHOPILO_URL = "https://shopilo.fr/reductions/prozis.com"
STORE_NAME = "Prozis"


def fetch_coupons(url=SHOPILO_URL):
    """Renvoie la liste des coupons actifs pour Prozis depuis shopilo.fr"""
    headers = {
        "User-Agent": "Mozilla/5.0 (compatible; coupon-fetcher/1.0; +https://github.com/shopilo-fr/code-promo-prozis)"
    }
    try:
